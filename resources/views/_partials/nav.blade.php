            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        @if(Auth::check())
                        <!-- <li class="nav-item"><a class="nav-link active" aria-current="page" href="/add-post">Add post</a></li> -->
                        <li><p class="nav-item"><a class="nav-link active" aria-current="page" href="/logout">Logout</a></p></li>
                        <li><p class="nav-item"><a class="nav-link active" aria-current="page" href="/account">Account Balance</a></p></li>
